...
export const SONGS: Song[] = [
  ...
  { id: "vowel-shapes", title: "Vowel shapes", credit: "Drill", kind: "drill", tier: 2, bpm: 72, beatsPerBar: 4, vowels: true, blurb: "One note, four vowel shapes. Pip reads each one from the sound.", steps: (["ah", "eh", "ee", "oo"] as const).flatMap((v): SongStep[] => [[0, 2, v], [null, 1]]).concat((["ah", "eh", "ee", "oo"] as const).flatMap((v): SongStep[] => [[4, 2, v], [null, 1]])) },
